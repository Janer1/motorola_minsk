...
DEVICE_PATH := device/motorola/minsk
...
# Assert
TARGET_OTA_ASSERT_DEVICE := minsk
...
TARGET_KERNEL_SOURCE := kernel/motorola/minsk
TARGET_KERNEL_CONFIG := minsk_defconfig
